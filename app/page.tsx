...
const solutionMedia: Record<string, string> = {
  ...
  onboardone: "/media/sol-onboardone.webp",
  shifthandover: "/media/sol-shifthandover.webp"
};

const painWords = ["Заявки", "Новички", "Смены", "Документы", "Отзывы", "Остатки", "Счета", "Партнёры", "Тендеры", "Конкуренты", "Переписки", "Публикации"] as const;
const calmWords = ["Одна боль", "Один инструмент", "Ответ в течение дня", "Без коробок", "Без магии", "Честные статусы"] as const;
...
export default function Home() {
  return <main>
    ...
    <section className="faq" id="faq">
      ...
      <Reveal><div className="faqCta"><a className="button" href="#form" data-mag>Остался вопрос — опишите его <ArrowUpRight size={18} /></a><p>Или напишите в Telegram: @bloodaman. Отвечаем в течение дня.</p></div></Reveal>
    </section>
    <footer>
