...
export default function Home() {
  return <main>
    ...
    <section className="diagnosis" id="diagnosis">
      ...
      <DiagnosisCards />
      <Reveal><p className="diagnosisEnd">Не надо внедрять монстра ради одной дырявой операции. Найдите свою боль — соберём для неё маленький, понятный инструмент. Ниже — пятнадцать таких болей: три уже в очереди на разработку, остальные ждут заявок.</p>
    ...
    <section className="solutions" id="solutions">
      <Reveal className="solutionCol"><div className="solutionIntro"><p className="sectionNo">02 / ПЕРВЫЕ УЗЛЫ</p><h2>Начнём с того,<br />что <em>болит каждый день.</em></h2><p className="introText">Три процесса, из которых чаще всего состоит ежедневная боль малого бизнеса. Они повторяются постоянно — поэтому стоят первыми в очереди на разработку.</p><a href="#form" className="buttonGhost introCta">Сразу описать боль <ArrowDownRight size={18} /></a></div></Reveal>
    ...
    <section className="catalogue" id="catalogue">
      <Reveal className="catalogueCol"><div className="catalogueSticky"><p className="sectionNo">03 / В РАБОТЕ</p><h2>Другие боли тоже<br /><em>не обязаны жить</em><br />в таблицах.</h2><p className="catalogueHint">Каждая строка — якорная ссылка на отдельную секцию: реальная ситуация, боль, пилот и три шага работы. Наведите на строку — увидите суть одной фразой.</p></div></Reveal>
      <div>
        ...
        <Reveal><div className="catalogueCta"><a href="#form" className="button">Моей боли нет в списке <ArrowUpRight size={18} /></a><p>Опишите её — повторяющиеся запросы берём в работу первыми.</p></div></Reveal>
      </div>
    </section>
    <section className="details" id="details">
      <Reveal><div className="detailsHead"><div><p className="sectionNo">04 / КАТАЛОГ В ДЕТАЛЯХ</p><h2>Пятнадцать узлов.<br />Каждый — <em>по-своему.</em></h2></div><p>Для каждого инструмента — реальная рабочая ситуация, одна конкретная боль, честное описание пилота и три шага работы. Это заявки на разработку, а не готовые сервисы: пилот проверяет, распутывается ли узел. Узнали свою ситуацию? Нажмите «Это моя боль» — мы подставим заготовку в форму, останется дописать детали.</p></div></Reveal>
    ...
    <section className="process" id="process">
      <Reveal><p className="sectionNo">05 / БЕЗ МАГИИ</p><div className="processTitle"><h2>Не обещаем<br />«подключить завтра».<br /><em>Сначала поймём.</em></h2><p>Это не готовая коробка и не внедрение на полгода. Берём в работу только те процессы, которые повторяются и действительно мешают. Вот путь от вашей заявки до пилота — наведите на шаг, чтобы увидеть, что нужно от вас и что от нас.</p></div></Reveal>
      <ProcessSteps />
    ...
    <section className="faq" id="faq">
      ...
      <Reveal><details><summary>Это уже готовые сервисы?<span>+</span></summary><p>Нет. Сейчас мы собираем заявки, чтобы брать в разработку самые повторяющиеся и дорогие для бизнеса процессы. Поэтому здесь честные статусы: «первый в очереди» или «проверяем спрос».</p></details></Reveal>
      <Reveal><details><summary>Сколько стоит пилот?<span>+</span></summary><p>Фиксированного прайса нет — и это честно: объём зависит от вашего процесса. После разбора боли мы называем условия до начала работы, а не после. Заявка и разбор ни к чему не обязывают.</p></details></Reveal>
      <Reveal><details><summary>Моей боли нет в каталоге. Стоит писать?<span>+</span></summary><p>Да. Каталог — это то, что уже назвали другие. Если ваша операция повторяется и дорого обходится, опишите её: повторяющиеся запросы берём в работу в первую очередь.</p></details></Reveal>
      <Reveal><details><summary>Вы подключаетесь к CRM, 1С или Telegram?<span>+</span></summary><p>Возможность и способ интеграции обсуждаем после разбора процесса. Не обещаем готовое подключение до технической оценки.</p></details></Reveal>
      <Reveal><details><summary>А если у нас уже есть CRM или 1С?<span>+</span></summary><p>Менять её не предлагаем. Микроинструмент закрывает один узел, до которого большой системе нет дела. Если окажется, что ваш узел уже закрывается имеющейся CRM, — скажем об этом прямо.</p></details></Reveal>
      <Reveal><details><summary>Можно прислать базу клиентов или документы?<span>+</span></summary><p>Не через эту форму. На первом шаге достаточно описать процесс без чувствительных данных.</p></details></Reveal>
      <Reveal><details><summary>Что будет после отправки заявки?<span>+</span></summary><p>Мы читаем описание и отвечаем в течение дня: задаём вопросы о процессе. Никаких рассылок, звонков «с предложением» и передачи контактов третьим лицам.</p></details></Reveal>
