...
- `AGENT-PLAYBOOK.md` — универсальный плейбук для нейросети: вставляется первым сообщением в Arena Agent Mode вместе с описанием ниши и ведёт проект по фазам до публикации.
